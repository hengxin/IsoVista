...
public class PostgreSQLCollector extends Collector<Long, Long> {
    ...
    protected void createTable() {
        ...
        statement.executeUpdate("CREATE TABLE IF NOT EXISTS dbtest.variables (var INT PRIMARY KEY, val INT)");
    }

    @Override
    @SneakyThrows
    protected void createVariables(long nKey) {
        // Instead of INSERT at the beginning, use INSERT ON CONFLICT DO UPDATE in execSession.
    }
